 ...
 * @date 2020/3/19.
 */
public class BeltStreamSelfWaterFastFoodDeviceStatus extends RedisDeviceStatus {
    private List<Integer> errorList;

    public BeltStreamSelfWaterFastFoodDeviceStatus() {
    }

    public BeltStreamSelfWaterFastFoodDeviceStatus(ChannelHandlerContext ctx, Message msg) {
        super(ctx, msg);
    }
